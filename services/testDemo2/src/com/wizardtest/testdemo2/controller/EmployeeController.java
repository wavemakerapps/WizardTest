...
package com.wizardtest.testdemo2.controller;
...
import com.wizardtest.testdemo2.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("testDemo2.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/testDemo2/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

    @Autowired
	@Qualifier("testDemo2.EmployeeService")
    ...
    @RequestMapping(value="/{id:.+}/employeesForMangerId", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeesForMangerId instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employee> findAssociatedEmployeesForMangerId(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeesForMangerId");
        return employeeService.findAssociatedEmployeesForMangerId(id, pageable);
    }
