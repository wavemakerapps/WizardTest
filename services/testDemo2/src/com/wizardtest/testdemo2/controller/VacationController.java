...
import com.wizardtest.testdemo2.service.VacationService;
...
public class VacationController {
    ...
    public Vacation editVacation(@PathVariable("id") Integer id, @RequestBody Vacation vacation) {
        LOGGER.debug("Editing Vacation with id: {}" , vacation.getVacId());

        vacation.setVacId(id);
