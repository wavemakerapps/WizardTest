...
package com.wizardtest.testdemo2.service;
...
import com.wizardtest.testdemo2.Employee;
import com.wizardtest.testdemo2.Vacation;
 ...
 * @see Employee
 */
@Service("testDemo2.EmployeeService")
@Validated
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Lazy
    @Autowired
    @Qualifier("testDemo2.VacationService")
    private VacationService vacationService;

    @Autowired
    @Qualifier("testDemo2.EmployeeDao")
    ...
    @Transactional(value = "testDemo2TransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "testDemo2TransactionManager")
    @Override
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "testDemo2TransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "testDemo2TransactionManager", timeout = 300)
    @Override
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service testDemo2 for table Employee to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service testDemo2 for table Employee to {} format", options.getExportType());
    ...
    @Transactional(readOnly = true, value = "testDemo2TransactionManager")
    @Override
    public Page<Employee> findAssociatedEmployeesForMangerId(Integer empId, Pageable pageable) {
        LOGGER.debug("Fetching all associated employeesForMangerId");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("employeeByMangerId.empId = '" + empId + "'");
