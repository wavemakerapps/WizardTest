 ...
 * @see Vacation
 */
@Service("testDemo2.VacationService")
@Validated
public class VacationServiceImpl implements VacationService {
    ...
    @Autowired
    @Qualifier("testDemo2.VacationDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service testDemo2 for table Vacation to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service testDemo2 for table Vacation to {} format", options.getExportType());
